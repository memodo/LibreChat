...
|---|-------|--------|------|-------|
| [0001](0001-mcp-byot-over-librechat-resolved-obo.md) | Authenticate Entra-delegated MCP servers via LibreChat-resolved BYOT over OBO | Accepted | 2026-05-18 | auth |
