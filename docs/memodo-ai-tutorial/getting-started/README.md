...
- **Narration audio** — `node docs/memodo-ai-tutorial/tooling/tts/narrate.mjs getting-started` (needs `ELEVENLABS_API_KEY`). Details: [`audio/README.md`](audio/README.md) and the "TTS" section of [`video-pipeline.md`](../video-pipeline.md).
